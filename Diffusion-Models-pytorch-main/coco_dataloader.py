...
# cwd = r'c:\Users\jules\Documents\Brown Work\Spring 2024\CS 2470\Final Project\Diffusion Model\data'
...
def get_train_data(batchsize:int):
    ...
    train_data = CustomCocoCaptions(root = cwd+'COCO2014valimg/val2014', # img
